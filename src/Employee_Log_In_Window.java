...
public class Employee_Log_In_Window extends JFrame
{
	String I;
	double P;
	String S;
	JCheckBox cb,cb2;
	public Employee_Log_In_Window()
	{
		super("Employee_Log_In_Window");
		...
		b.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				{ 
					...
					ResultSet myRs=myStmt.executeQuery("select * from STBank.EmployeeData where EId like '"+I+"' and Password="+P+"");
					if(!myRs.next())
					{
						JOptionPane.showMessageDialog(null,"Wrong Employee ID or Wrong Password");
					}
					else
					{
