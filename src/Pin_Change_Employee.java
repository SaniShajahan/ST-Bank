...
public class Pin_Change_Employee extends JFrame
{
	String OP;
	String NP;
	String RP;
	public Pin_Change_Employee(String I)
	{
		super("Pin_Change_Employee");
		...
		C.addActionListener(new ActionListener() //500
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						...
						{ 
							...
							ResultSet myRs=myStmt.executeQuery("select * from STBank.EmployeeData where EId='"+I+"'");
							while(myRs.next()) 
							{ 
								if(OP.equals(myRs.getString("Password")))
								{
									if(NP.equals(RP))
									{
										...
										myStmt.executeUpdate("update STBank.EmployeeData set Password='"+RP+"' where EId='"+I+"'");
						...
						/*JOptionPane.showMessageDialog(null,"Password has been changed");
						Employee_Window EW=new Employee_Window();
						setVisible(false);
						dispose();
						EW.setVisible(true);*/
